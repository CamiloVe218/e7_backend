...
let ProvidersController = class ProvidersController {
    ...
    findAll(lat, lng, radius) {
        return this.providersService.findAll(lat ? parseFloat(lat) : undefined, lng ? parseFloat(lng) : undefined, radius ? parseFloat(radius) : undefined);
    }
    getMyProfile(user) {
